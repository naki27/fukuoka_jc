    ...
    <Container className={classes.root} maxWidth={false}>
      ...
      <div className={classes.keyVisualContainer}>
        <Picture className={classes.keyVisual}
            sources = {[
                {   // https://drive.google.com/file/d/1bpGPvRb5giDlnKGc9nLVGmLW559ttzsq/view?usp=sharing
                    srcSet: "https://drive.google.com/uc?id=1bpGPvRb5giDlnKGc9nLVGmLW559ttzsq",
                    media: "(max-width: 400px)",
                },
                {   // 768px https://drive.google.com/file/d/1rA8Ucm_phR1l6GU2IwHQ5Fve9EBQ4acZ/view?usp=sharing
                  srcSet: "https://drive.google.com/uc?id=1rA8Ucm_phR1l6GU2IwHQ5Fve9EBQ4acZ",
                  media: "(max-width: 768px)",
                },
                {   // 1024px https://drive.google.com/file/d/1PlYZB2TemoOPBtnwOoi0QxeeUmHT2NfM/view?usp=sharing
                  srcSet: "https://drive.google.com/uc?id=1PlYZB2TemoOPBtnwOoi0QxeeUmHT2NfM",
                  media: "(max-width: 1024px)",
                },
                {   // 1280px https://drive.google.com/file/d/1Knqj49ynYskkOEfRyjGdlm7KnhBEex_7/view?usp=sharing
                    srcSet: "https://drive.google.com/uc?id=1Knqj49ynYskkOEfRyjGdlm7KnhBEex_7",
                    media: "(max-width: 1280px)",
                },
                {   // 1920px https://drive.google.com/file/d/15jt32BJdNKpq5iAltItrbN3ytOXawbCz/view?usp=sharing
                    srcSet: "https://drive.google.com/uc?id=15jt32BJdNKpq5iAltItrbN3ytOXawbCz",
                },
            ]}
        />
      </div>
