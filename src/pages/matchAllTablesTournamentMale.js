...
const matchAllTablesTournamentMale = () => {
    ...
    const handleDownload = async () => {
        try {
            ...
            a.href = url;
            a.download = `決勝トーナメント組み合わせ_男子.pdf`;
        ...
        <>
            ...
            <Container maxWidth="lg">
                <Breadcrumbs aria-label="breadcrumb">
                    ...
                    <Typography color="textPrimary">決勝トーナメント組み合わせ（男子）</Typography>
                </Breadcrumbs>

                <H1 title={isMobile ? "決勝（男子）" : "決勝トーナメント組み合わせ（男子）"} />
...
export default matchAllTablesTournamentMale;
