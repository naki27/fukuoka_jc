        ...
        <>
            ...
            <Container maxWidth="lg">
                ...
                <div className={styles.content}>
                    ...
                    <p className={styles.Important}>※受付を済ませないチームは棄権とみなします。必ず両日とも時間内に受付を行ってください。</p>
                </div>
                ...
                <div className={styles.content}>
                    ...
                    <p className={styles.Important}>開会式には監督・主将のみとします。その他の選手は、各待機場所にて待機ください</p>
                ...
                <div className={styles.content}>
                    ...
                    <p className={styles.Important}>*予選リーグ戦および決勝トーナメント戦の<span className={styles.Red}>準々決勝</span>までは、3 セットすべてラリーポイントの15点先取とし、3セット目のチェンジコートは行いません。(ジュースはありません。)</p>
                ...
                <H2 title="6. 審判" />
                <div className={styles.content}>
                    <p>3月19日(土)は、各チームとも<span className={styles.Important}>大会冊子にてコート別試合進行表</span>を確認の上、副審・得点掲示員、線審 2 名をお願いします。第 2 試合以降につきましても、コート別試合進行表をご確認ください。</p>
                    <p>前の試合終了後、直ちに次の試合を開始します。<span className={styles.Important}>試合の進行がスムーズに行えるよう、帯同審判員、選手の皆さんのご協力をお願いします。</span></p>
                    ...
                    <p className={styles.Important}>プロトコルは、サービスラインにて行い試合開始前にトスを行います。</p>
                ...
                <div className={styles.content}>
                    ...
                    <p>大会本部では、<span className={styles.Important}>参加選手年齢が参加資格に違反していたことが判明した時点で、当該チームは失格とし、判明した時点以降の試合は棄権とします。</span>なお、全試合終了後に判明した場合には、入賞記録を抹消し改めて順位を決定するものとします。</p>
                    ...
                    <ul>
                        ...
                        <li className={styles.Important}>ユニフォーム規定に違反していたことが判明した時点(本部に記録表が提出される前まで)で、当該チームは失格とし、判明した時点以降の試合は棄権とします。</li>
                    </ul>
                ...
                <div className={styles.content}>
                    ...
                    <div className={styles.teamPlate}>
                        <div className={styles.teamTitle}><span>男子１８歳以上の部</span><span>福岡県春日市</span></div>
                        <div className={styles.teamName}>福岡県ビーチボール協会</div>
                    </div>
                </div>
                ...
                <div className={styles.content}>
                    ...
                    <p><span className={styles.Important}>コンセントは使用禁止</span>です。</p>
                    <p>公共施設をお借りしておりますので使用上の注意を必ずお守りください。</p>
                </div>

                <H2 title="13. 新型コロナウイルス感染症対策" />
                <div className={styles.content}>
                    <p>プレー中以外は、必ずマスク着用をお願いします。<span className={styles.Important}>マスクは参加賞のマスクを着用してください。大会関係者の目印として有効活用致します。</span></p>
                    <p>受付時に、監督、役員、審判、スタッフ等は<span className={styles.Important}>「健康チェックシート兼誓約書」</span>を提出してください。大会運営関係者の健康状態の把握、来場可否の判断及び必要な連絡の為にのみ利用します。</p>
                    <p>試合中、1 セット毎にボール、ネット等をコート係が消毒します。</p>
                    <p>試合間は、審判台、得点板、フラッグ、ネット、ボール等をコート係が消毒します。</p>
                    <p>館内を定期式に消毒に回ります。</p>
                    <p className={styles.Important}>飲食の際は、間隔をとり、黙食に心掛けてください。</p>
                    <p className={styles.Important}>各自、定期的な手洗い、消毒を行い、感染予防の徹底をお願いします。</p>
                    <p className={styles.Important}>大会後 2 週間以内に、感染した際は、すみやかに大会本部への連絡を行ってください。</p>
                </div>
