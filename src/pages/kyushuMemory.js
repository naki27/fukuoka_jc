        ...
        <>
            ...
            <Container className={classes.root} maxWidth={false}>
              ...
              <div id="body" className={classes.init}>
                <a href="https://photos.app.goo.gl/JgGnpqoprJMhbRAB6" className={classes.photoLink}>
                  男子はこちら
                </a>

                <a href="https://photos.app.goo.gl/s9TAi159CCaE1tUA9" className={classes.photoLink}>
                  女子はこちら
                </a>
              </div>
            </Container>
